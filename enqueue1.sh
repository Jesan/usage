...
curl -d '{"switch": "00:00:a0:36:9f:1e:0c:cd", "name":"'"$name"'", "cookie":"0","dst-mac":"'"$device_id"'","active":"true", "actions":"enqueue=2:1"}' http://149.171.37.183:8080/wm/staticflowentrypusher/json
