...
sudo ovs-vsctl -- -- set port em3 qos=@newqos -- --id=@newqos  create qos type=linux-htb queues=1=@q1 -- --id=@q1 create queues other-config:min-rate=$minrate other-config:max-rate=$maxrate
